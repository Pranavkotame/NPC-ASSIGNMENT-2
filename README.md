...
**Author:** Kotame Pranav  
**PRN:** 2125UCSM1061  
**Repository:** [NPC-ASSIGNMENT-2](https://github.com/Pranavkotame/NPC-ASSIGNMENT-2)  
...
![Figure 1: TCP Three-Way Handshake](./screenshots/screenshots/Figure_1_TCP_Handshake.png)

### Figure 2: HTTP GET Request & HTTP 200 OK Response (`http` filter)
Filter displaying HTTP GET request and 200 OK response:
![Figure 2: HTTP Traffic](./screenshots/screenshots/Figure_2_HTTP_Traffic.png)
...
- `screenshots/Figure_1_TCP_Handshake.png`: Wireshark screenshot showing TCP stream 7 handshake.
- `screenshots/Figure_2_HTTP_Traffic.png`: Wireshark screenshot showing HTTP packets.
